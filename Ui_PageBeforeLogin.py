...
"")
        ...
        self.pushButton_greenlight = QtWidgets.QPushButton(self.frame_right)
        self.pushButton_greenlight.setGeometry(QtCore.QRect(10, 10, 65, 21))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_greenlight.sizePolicy().hasHeightForWidth())
        self.pushButton_greenlight.setSizePolicy(sizePolicy)
        self.pushButton_greenlight.setStyleSheet("QPushButton{\n"
"background-color: rgba(255, 255, 255,0);\n"
"boder:none;\n"
"}\n"
"")
        self.pushButton_greenlight.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/ico/ico/greenpoint.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_greenlight.setIcon(icon3)
        self.pushButton_greenlight.setObjectName("pushButton_greenlight")
        self.connect = QtWidgets.QLabel(self.frame_right)
        self.connect.setGeometry(QtCore.QRect(60, 10, 101, 21))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(15)
        self.connect.setFont(font)
        self.connect.setStyleSheet("color: rgb(248, 237, 83);")
...
"border-bottom:2px solid rgb(0,0,0);\n"
"background-color: rgba(0, 0, 0,0);")
        self.lineEdit_port_s.setEchoMode(QtWidgets.QLineEdit.Password)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_ip.setText(_translate("MainWindow", "10.191.210.1"))
        self.connect.setText(_translate("MainWindow", "Connected"))
